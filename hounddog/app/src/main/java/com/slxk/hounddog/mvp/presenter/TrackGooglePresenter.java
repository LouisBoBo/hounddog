 ...
 */
@ActivityScope
public class TrackGooglePresenter extends BasePresenter<TrackGoogleContract.Model, TrackGoogleContract.View> {
    @Inject
    ...
    @Inject
    public TrackGooglePresenter (TrackGoogleContract.Model model, TrackGoogleContract.View rootView) {
