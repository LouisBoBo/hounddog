 ...
 */
@FragmentScope
public class GoogleLocationModel extends BaseModel implements GoogleLocationContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public GoogleLocationModel(IRepositoryManager repositoryManager) {
