...
import com.slxk.hounddog.di.component.DaggerMainWirelessComponent;
...
import com.slxk.hounddog.mvp.presenter.MainWirelessPresenter;
 ...
 * ================================================
 */
public class MainWirelessActivity extends BaseActivity<MainWirelessPresenter> implements MainWirelessContract.View {
    ...
    public static Intent newInstance() {
        return new Intent(MyApplication.getMyApp(), MainWirelessActivity.class);
    }

    @Override
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerMainWirelessComponent.builder()
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_main_wireless;//setContentView(id);
    }
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < mTitles.size(); i++) {
            if (i == 0) {
                if (mapType == 2) {
                    if (isChina){
                        mFragments.add(AmapLocationWirelessFragment.newInstance());
                    }else{
                        mFragments.add(GoogleLocationWirelessFragment.newInstance());
                    }
                } else if (mapType == 1) {
                    mFragments.add(BaiduLocationWirelessFragment.newInstance());
                } else {
                    mFragments.add(AmapLocationWirelessFragment.newInstance());
                }
            } else if (i == 1) {
                mFragments.add(CompassWirelessFragment.newInstance());
            } else if (i == 2) {
                mFragments.add(DeviceListWirelessFragment.newInstance());
            }
        }
    ...
    @OnClick({R.id.iv_more_function, R.id.btn_network})
    ...
    private void onCheckAppLocationMode(){
        SPUtils.getInstance().put(ConstantValue.APP_Location_Mode, 1);
    ...
    private void onNetWorkLocation() {
        btnWireless.setBackground(getResources().getDrawable(R.drawable.bg_1464f6_fillet_3));
        btnWireless.setTextColor(getResources().getColor(R.color.color_FFFFFF));
        btnNetwork.setBackground(getResources().getDrawable(R.drawable.bg_ffffff_fillet_3));
        btnNetwork.setTextColor(getResources().getColor(R.color.color_333333));
    }
