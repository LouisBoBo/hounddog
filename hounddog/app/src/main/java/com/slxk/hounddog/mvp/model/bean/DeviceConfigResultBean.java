...
public class DeviceConfigResultBean extends BaseBean {
    ...
    private int sms_msg; // 短信透传能力,-1不支持,1支持,2支持，但是sim卡无效不可用
    private int vibration; // 是否支持震动0不支持，1支持老版本的,2支持带有设防震动
    ...
    public void setSms_msg(int sms_msg) {
    ...
    public static class ConfigBean {
        ...
        private PhoneAlarmBean phone_alarm; // 电话报警

        public PhoneAlarmBean getPhone_alarm() {
            return phone_alarm;
        }

        public void setPhone_alarm(PhoneAlarmBean phone_alarm) {
            this.phone_alarm = phone_alarm;
        }
        ...
        public static class CarSwitchBean {
            ...
            private int protect; // 设防开关,默认关闭 0关闭，1开启，-1不支持
            private int lowpowermodeswitch; // 低电模式开关
            ...
            public int getLowpowermodeswitch() {
                return lowpowermodeswitch;
            }

            public void setLowpowermodeswitch(int lowpowermodeswitch) {
                this.lowpowermodeswitch = lowpowermodeswitch;
            }

        }

        public static class PhoneAlarmBean {

            private String acc; // acc非法启动报警的方式
            private String out; // 断电报警的方式
            private int total = 0; // 电话通知次数
            private String vibration; // 震动报警的方式
