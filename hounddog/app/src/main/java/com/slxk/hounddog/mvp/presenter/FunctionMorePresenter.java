 ...
 */
@ActivityScope
public class FunctionMorePresenter extends BasePresenter<FunctionMoreContract.Model, FunctionMoreContract.View> {
    @Inject
    ...
    @Inject
    public FunctionMorePresenter(FunctionMoreContract.Model model, FunctionMoreContract.View rootView) {
