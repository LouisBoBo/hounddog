 ...
 */
@FragmentScope
public class AmapLocationWirelessPresenter extends BasePresenter<AmapLocationWirelessContract.Model, AmapLocationWirelessContract.View> {
    @Inject
    ...
    @Inject
    public AmapLocationWirelessPresenter (AmapLocationWirelessContract.Model model, AmapLocationWirelessContract.View rootView) {
