...
public class BitmapHelperAmap {
    ...
    // 用户定位图标
    private BitmapDescriptor user_location_map;
    ...
    public BitmapHelperAmap(Context context) {
        ...
        Bitmap userBitmap_map = BitmapFactory.decodeResource(context.getResources(), R.drawable.icon_user_location_map);
        ...
        user_location_map = BitmapDescriptorFactory.fromBitmap(userBitmap_map);
...
//        }
     ...
     * @return
     */
    public BitmapDescriptor getBitmapZoomForUserLocationMap(float zoom) {
//        if (zoom >= 17) {
//            return user_location;
//        } else if (zoom < 17 && zoom >= 15) {
//            return user_location_08;
