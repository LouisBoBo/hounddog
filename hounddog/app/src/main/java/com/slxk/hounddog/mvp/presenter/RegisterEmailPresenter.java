 ...
 */
@ActivityScope
public class RegisterEmailPresenter extends BasePresenter<RegisterEmailContract.Model, RegisterEmailContract.View> {
    @Inject
    ...
    @Inject
    public RegisterEmailPresenter(RegisterEmailContract.Model model, RegisterEmailContract.View rootView) {
