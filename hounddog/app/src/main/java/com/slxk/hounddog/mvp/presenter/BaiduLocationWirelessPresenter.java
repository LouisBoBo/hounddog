 ...
 */
@FragmentScope
public class BaiduLocationWirelessPresenter extends BasePresenter<BaiduLocationWirelessContract.Model, BaiduLocationWirelessContract.View> {
    @Inject
    ...
    @Inject
    public BaiduLocationWirelessPresenter(BaiduLocationWirelessContract.Model model, BaiduLocationWirelessContract.View rootView) {
