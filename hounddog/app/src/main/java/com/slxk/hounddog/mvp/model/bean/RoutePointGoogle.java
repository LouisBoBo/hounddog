...
public class RoutePointGoogle {
	...
	public RoutePointGoogle(LatLng point, int type, long time, int speed, double lat, double lon, float direction, int ptype,
