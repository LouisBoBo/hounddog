 ...
 */
@FragmentScope
public class AmapLocationPresenter extends BasePresenter<AmapLocationContract.Model, AmapLocationContract.View> {
    @Inject
    ...
    @Inject
    public AmapLocationPresenter(AmapLocationContract.Model model, AmapLocationContract.View rootView) {
