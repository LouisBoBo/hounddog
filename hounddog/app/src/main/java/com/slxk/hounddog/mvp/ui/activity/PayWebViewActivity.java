...
import com.slxk.hounddog.di.component.DaggerPayWebViewComponent;
import com.slxk.hounddog.mvp.contract.PayWebViewContract;
import com.slxk.hounddog.mvp.model.api.Api;
import com.slxk.hounddog.mvp.presenter.PayWebViewPresenter;
...
public class PayWebViewActivity extends BaseActivity<PayWebViewPresenter> implements PayWebViewContract.View {
    ...
    private final static String Key_Title = "PayWebViewActivity.title";
    private final static String Key_Url = "PayWebViewActivity.url";
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (Api.Pay_Sim_Success_Return.equals(url)) {
                    ...
                    try {
                        ...
                        //处理错误
                        e.printStackTrace();
                        ToastUtils.showShort(getString(R.string.no_install_aliPay));
                    }
                } else {
