...
public class TriangleView extends View {
    ...
    private static final int DEFUALT_WIDTH = 16;
    private static final int DEFUALT_HEIGHT = 90;
    ...
    public TriangleView(Context context, int colorId) {
        this(context, null);
...
//                mPath.moveTo(mWidth/3f,mHeight);
//                mPath.lineTo(mWidth/3f,mHeight/4f);
//                mPath.lineTo(mWidth/3*2f,mHeight/4f);
//                mPath.lineTo(mWidth/3*2f,mHeight);
//
//                mPath.moveTo(0,mHeight/4f);
//                mPath.lineTo(mWidth,mHeight/4f);
//                mPath.lineTo(mWidth/2f,0);

                mPath.moveTo(mWidth/3f,mHeight);
                mPath.lineTo(mWidth/3f,mHeight/4f);
                mPath.lineTo(0,mHeight/4f);
                mPath.lineTo(mWidth/2f,0);
                mPath.lineTo(mWidth,mHeight/4);
                mPath.lineTo(mWidth/3*2f,mHeight/4);
                mPath.lineTo(mWidth/3*2f,mHeight);
