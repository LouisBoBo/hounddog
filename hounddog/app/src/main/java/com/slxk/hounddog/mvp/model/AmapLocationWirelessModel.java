 ...
 */
@FragmentScope
public class AmapLocationWirelessModel extends BaseModel implements AmapLocationWirelessContract.Model{
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public AmapLocationWirelessModel(IRepositoryManager repositoryManager) {
