 ...
 */
@FragmentScope
public class GoogleLocationWirelessModel extends BaseModel implements GoogleLocationWirelessContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public GoogleLocationWirelessModel(IRepositoryManager repositoryManager) {
