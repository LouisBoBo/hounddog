 ...
 */
package com.slxk.hounddog.mvp.ui.view.data.haibin;
...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.slxk.hounddog.mvp.ui.view.data.haibin.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.slxk.hounddog.mvp.ui.view.data.haibin.WeekBar".equalsIgnoreCase(getClass().getName())) {
