 ...
 */
@FragmentScope
public class BaiduLocationPresenter extends BasePresenter<BaiduLocationContract.Model, BaiduLocationContract.View> {
    @Inject
    ...
    @Inject
    public BaiduLocationPresenter (BaiduLocationContract.Model model, BaiduLocationContract.View rootView) {
