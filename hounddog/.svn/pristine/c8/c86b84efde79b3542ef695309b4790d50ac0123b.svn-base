 ...
 */
@ActivityScope
public class BindMobileNextPresenter extends BasePresenter<BindMobileNextContract.Model, BindMobileNextContract.View> {
    @Inject
    ...
    @Inject
    public BindMobileNextPresenter(BindMobileNextContract.Model model, BindMobileNextContract.View rootView) {
