...
//    String APP_DOMAIN = isRelease ? "http://yjzx.8325.com" : "http://sl.8325.com"; // API域名
    ...
    // sim卡充值
    String Pay_Sim_Recharge = isRelease ? "http://cx.52zdx.com/mobile/sim/pay" : "http://webcs.cciot.cc/mobile/sim/pay"; //测试 http://webcs.cciot.cc/pay/  正式 http://web.cciot.cc/pay/
    //支付完成返回
    String Pay_Sim_Success_Return = isRelease ? "http://cx.52zdx.com/mobile/sim/pay/return" : "http://webcs.cciot.cc/mobile/sim/pay/return"; //测试 http://webcs.cciot.cc/pay/return  正式 http://web.cciot.cc/pay/return
    //支付完成返回
